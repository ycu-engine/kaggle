...
def choose_colorbrewer_palette(data_type, as_cmap=...):
...
def choose_dark_palette(input=..., as_cmap=...):
...
def choose_light_palette(input=..., as_cmap=...):
...
def choose_diverging_palette(as_cmap=...):
...
def choose_cubehelix_palette(as_cmap=...):
