...
def color_palette(palette=..., n_colors=..., desat=..., as_cmap=...):
...
def hls_palette(n_colors=..., h=..., l=..., s=..., as_cmap=...):
...
def husl_palette(n_colors=..., h=..., s=..., l=..., as_cmap=...):
...
def mpl_palette(name, n_colors=..., as_cmap=...):
...
def dark_palette(color, n_colors=..., reverse=..., as_cmap=..., input=...):
...
def light_palette(color, n_colors=..., reverse=..., as_cmap=..., input=...):
...
def diverging_palette(h_neg, h_pos, s=..., l=..., sep=..., n=..., center=..., as_cmap=...):
...
def blend_palette(colors, n_colors=..., as_cmap=..., input=...):
...
def cubehelix_palette(n_colors=..., start=..., rot=..., gamma=..., hue=..., light=..., dark=..., reverse=..., as_cmap=...):
