...
class VectorPlotter:
    ...
    @classmethod
    def get_semantics(cls, kwargs, semantics=...):
    ...
    def assign_variables(self, data=..., variables=...):
        """Define plot variables, optionally using lookup from `data`."""
        ...
    
    def iter_data(self, grouping_vars=..., reverse=..., from_comp_data=...):
...
def variable_type(vector, boolean_type=...):
    """
...
def categorical_order(vector, order=...):
