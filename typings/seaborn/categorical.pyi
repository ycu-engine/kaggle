...
class _ViolinPlotter(_CategoricalPlotter):
    ...
    def draw_quartiles(self, ax, data, support, density, center, split=...):
    ...
    def draw_stick_lines(self, ax, data, support, density, center, split=...):
...
class _CategoricalStatPlotter(_CategoricalPlotter):
    ...
    def draw_confints(self, ax, at_group, confint, colors, errwidth=..., capsize=..., **kws):
        ...
...
@_deprecate_positional_args
def pointplot(*, x=..., y=..., hue=..., data=..., order=..., hue_order=..., estimator=..., ci=..., n_boot=..., units=..., seed=..., markers=..., linestyles=..., dodge=..., join=..., scale=..., orient=..., color=..., palette=..., errwidth=..., capsize=..., ax=..., **kwargs):
    ...
